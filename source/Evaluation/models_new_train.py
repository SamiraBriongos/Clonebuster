...
"""         # Compare Algorithms
        plt.figure(figsize=(15, 6))
        plt.boxplot(results_ac, labels=names)
        ...
        plt.figure(figsize=(15, 6))
        plt.boxplot(results_pr, labels=names)
        # plt.title('Algorithm Comparison')
        ...
        plt.figure(figsize=(15, 6))
        plt.boxplot(results_re, labels=names)
        # plt.title('Algorithm Comparison')
        plt.ylabel('Recall')
        plt.tight_layout()
        plt.show()
...
"""     text_representation = tree.export_text(model, max_depth=30)
...
"""
    # Test one of the algorithms on a fit model
    ...
    # plot_confusion_matrix(model, X_validation, Y_validation)  # doctest: +SKIP
    # plt.show()
"""
